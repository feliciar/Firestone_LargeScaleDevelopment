...
public class DamageHandlerTest {
    ...
    public void testDealDamageToMinionAndHero() {
        ...
        FirestoneMinion minionPlayer1 = new FirestoneMinion("100", "Boulderfist Ogre", 7, 7, 6, 6, MinionRace.NONE,
                null, null, null);
    ...
    public void testDealDamageToMinions() {
        ...
        FirestoneMinion minionPlayer1 = new FirestoneMinion("100", "Boulderfist Ogre", 7, 7, 6, 6, MinionRace.NONE,
                null, null, null);
        minionPlayer1.setSleepy(false);
        FirestoneMinion minionPlayer2 = new FirestoneMinion("200", "Boulderfist Ogre", 7, 7, 6, 6, MinionRace.NONE,
                null, null, null);
    ...
    public void testFindDeadMinions() {
        ...
        FirestoneMinion minion1 = new FirestoneMinion("200", "Boulderfist Ogre", 7, 7, 6, 6, MinionRace.NONE, null,
                null, null);
