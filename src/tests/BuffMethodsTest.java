...
public class BuffMethodsTest {
    ...
    public BuffMethodsTest() {
        ...
        minions.add(new FirestoneMinion("uniqueId-1", "Imp", 1, 1, 1, 1, MinionRace.DEMON, new ArrayList<>(), "",
                buffHandler));
        minions.add(new FirestoneMinion("uniqueId-2", "War Golem", 7, 7, 7, 7, MinionRace.NONE, new ArrayList<>(), "",
                buffHandler));
        minions.add(new FirestoneMinion("uniqueId-3", "Twilight Drake", 1, 1, 4, 4, MinionRace.DRAGON,
                new ArrayList<>(), "Battlecry: Gain +1 Health for each card in your hand.", buffHandler));
    }
    ...
    public void testWhenHoldingDragonDealThreeDamage() {
        Action action1 = new Action(players, "currentPlayerId", "playedCardId", "minionCreatedId", 0, "targetHero",
                null, Action.Type.DAMAGE);
        Action action2 = new Action(players, "currentPlayerId", "playedCardId", "minionCreatedId", 0, "uniqueId-1",
                null, Action.Type.DAMAGE);
    ...
    public void testGainOneHealthForCardsInHand() {
        Action action = new Action(players, "currentPlayerId", "playedCardId", "minionCreatedId", 0, null, null,
                Action.Type.DAMAGE);
    ...
    public void testGainTwoForCardsPlayedThisTurn() {
        Action action = new Action(players, "currentPlayerId", "playedCardId", "uniqueId-1", 0, null, null,
                Action.Type.DAMAGE);
    ...
    public void testAfterSpellDealOneDamageToAllMinions() {
        Action action = new Action(players, "currentPlayerId", "playedCardId", null, -1, null, null,
                Action.Type.PLAYED_CARD);
        List<Minion> minionsp1 = new ArrayList<>();
        minionsp1.add(new FirestoneMinion("uniqueId-3", "Wild Pyromancer", 2, 2, 3, 3, MinionRace.NONE,
                new ArrayList<>(), "After you cast a spell, deal 1 damage to ALL minions.", buffHandler));
    ...
    public void testDealThreeDamageToAndFreezeCharacter() {
        Action action = new Action(players, "currentPlayerId", "playedCardId", null, -1, "uniqueId-2", null,
                Action.Type.PLAYED_CARD);
        FirestoneHero hero = new FirestoneHero("heroId", null, 30, null);
    ...
    public void testReturnOwnMinionToHand() {
        ...
        int manaCost = 3;
        Card c = new FirestoneCard("playedCardId", "War Golem", "2", "2", "" + manaCost, Card.Type.MINION.toString(),
                "", MinionRace.NONE.toString());
        Minion m = minions.get(1);
        discardPileThisTurn.add(c);
        when(p1.getDiscardPile()).thenReturn(dp);

        Action action = new Action(players, "currentPlayerId", "playedCardId", null, 0, "uniqueId-2", null,
                Action.Type.PLAYED_CARD);
        Minion minion = null;
        ...
        action = new Action(players, "currentPlayerId", "playedCardId", null, 0, "uniqueId-1", null,
                Action.Type.PLAYED_CARD);
        minion = null;

        manaCost = 1;
        c = new FirestoneCard("playedCardId", "Imp", "2", "2", "" + manaCost, Card.Type.MINION.toString(), "",
                MinionRace.NONE.toString());
        discardPileThisTurn.add(c);
    ...
    public void testDealTwoDamageToUndamagedMinion() {
        ...
        action = new Action(players, "currentPlayerId", "playedCardId", "minionCreatedId", 0, "uniqueId-2", null,
                Action.Type.PLAYED_CARD);
        int minionHealth = 3;
    ...
    public void testSetHeroHealthTo15() {
        Action action = new Action(players, "currentPlayerId", "playedCardId", "minionCreatedId", 0, "targetId", null,
                Action.Type.PLAYED_CARD);
    ...
    public void testDrawCardWhenThisMinionTakesDamage() {
        Action action = new Action(players, "currentPlayerId", "playedCardId", "minionCreatedId", 0, null, "uniqueId-2",
                Action.Type.DAMAGE);
    ...
    public void testCopyOponentsPlayedSpellCardIntoHand() {
        ...
        buffMethods.copyOpponentsPlayedSpellCardIntoHand(action,
                new FirestoneMinion("", "", 0, 0, 0, 0, null, null, null, null), true);
    ...
    public void testLesserHeal() {
        Action action1 = new Action(players, "currentPlayerId", null, null, 0, "targetId", null,
                Action.Type.HERO_POWER);
        Action action2 = new Action(players, "currentPlayerId", null, null, 0, "uniqueId-1", null,
                Action.Type.HERO_POWER);
