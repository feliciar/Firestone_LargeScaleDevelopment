...
public class AttackHandlerTest {
    ...
    public AttackHandlerTest() {
        ...
        minionPlayer1 = new FirestoneMinion("100", "Boulderfist Ogre", 7, 7, 6, 6, MinionRace.NONE, new ArrayList<>(),
                null, null);
        ...
        minionPlayer2 = new FirestoneMinion("200", "Boulderfist Ogre", 7, 7, 6, 6, MinionRace.NONE, new ArrayList<>(),
                null, null);
    ...
    public void testisMinionAttackValid() {
        ...
        // Test if an minion that does not exist for the player is used to
        // attack
