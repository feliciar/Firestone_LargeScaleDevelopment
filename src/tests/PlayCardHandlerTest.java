...
public class PlayCardHandlerTest {
    ...
    public void testPlaySpellCardPlayerCard() {
        ...
        int manaCost = 5;
        Card card = new FirestoneCard(UUID.randomUUID().toString(), "Imp", "1", "1", "" + manaCost, "SPELL", "",
                "NONE");
        ...
        discardPile.add(
                new FirestoneCard(UUID.randomUUID().toString(), "Imp", "1", "1", "" + manaCost, "SPELL", "", "NONE"));
    ...
    public void testPlayMinionCardPlayerCardInt() {
        ...
        hand.remove(card);
        minions.add(index1,
                new FirestoneMinion(UUID.randomUUID().toString(), card.getName(), card.getHealth().get(),
                        card.getOriginalHealth().get(), card.getOriginalAttack().get(), card.getAttack().get(), race,
                        states, null, null));
