...
public class BuffHandlerTest {
	...
	public void testPerformBuffOnPlayedMinionCard(){
		...
		Action action = new Action(players, players.get(1).getId(), minionCard2.getId(), minions2.get(0).getId(), 
	...
	public void isPerformBuffValid(){
		...
		Action action = new Action(players, players.get(1).getId(), minionCard2.getId(), null, 
		...
		action = new Action(players, players.get(1).getId(), minionCard2.getId(), null, 
				-1, null, null, Action.Type.PLAYED_CARD);
		assertFalse(buffHandler.isPerformBuffValid(action));
		
		//Test other buff, with target
		action = new Action(players, players.get(0).getId(), minionCard1.getId(), null, 
				-1, "1", null, Action.Type.PLAYED_CARD);
		assertFalse(buffHandler.isPerformBuffValid(action));
	...
	public void testPerformBuffOnPlayedSpellCard(){
		...
		Action action = new Action(players, players.get(0).getId(), spellCard.getId(), null, 
				-1, null, null, Action.Type.PLAYED_CARD);
	...
	public void testPerformBuff() {
		...
		Action action = new Action(players, players.get(0).getId(), minionCard1.getId(), null, 
				-1, null, null, Action.Type.PLAYED_CARD);
	...
	public void testMap(){
		...
		assert(buffHandler.invokeBuff(new Action(players, players.get(0).getId(), minionCard1.getId(), null, 
