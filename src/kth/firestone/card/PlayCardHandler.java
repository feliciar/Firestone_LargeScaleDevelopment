...
public class PlayCardHandler {
	...
	public static int MAX_CARDS_ALLOWED_ON_THE_BOARD = 7;
	...
	/**
	 * Playing a minion. Removes the card from the players hand, reduces the mana, creates the minion, and puts it on
	 * the board Then discard the card
	 * 
	 * @param player
	 *            the player playing the card
	 * @param card
	 *            the card to play
	 * @param position
	 *            the position on the board where the minion will be positioned
	 * @return a list of all events that has happened.
	 */
	 ...
	 *            the card to play
	 * @param targetId
	 *            the id of the target of the card
	 * @return a list of all events that has happened.
	 */
	 ...
	 *            the card to be played
	 * @param targetId
	 *            the id of the target that of the card
	 * @return true if the play is valid
	 */
