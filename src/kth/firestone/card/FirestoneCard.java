...
public class FirestoneCard implements Card {
    ...
    public FirestoneCard(String id, String name, String health, String attack, String manaCost, String type,
    ...
    public String toString() {
        return name + "(" + manaCost + ") (" + health.get() + "/" + originalHealth.get() + ", " + attack.get() + "/"
                + originalAttack.get() + ")";
    }
