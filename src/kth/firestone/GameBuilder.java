...
public interface GameBuilder {
	 ...
	 * 
	 * @param playerIndex the index of the player. The first player has index 1 and so on
	 ...
	 * 
	 * @param playerIndex the index of the player. The first player has index 1 and so on
	 * @param numberOfCards determines how many of cardName that should be set in the deck
	...
	/**
	 * Sets the active minions on the board. The minions will trigger their properties as if they were played.
	 * 
	 * @param playerIndex the index of the player. The first player has index 1 and so on
