...
public class BuffMethods {
	...
	/**
	 * Method for performing buff: "Whenever a player casts a spell, put a copy into the other player's hand."
	 * 
	 * @param action
	 *            the action that just took place
	 * @param minion
	...
	/**
	 * Method for performing buff: "Charge"
	 * 
	 * @param action
	 *            the action that just took place
	 * @param minion
	...
	/**
	 * Method for performing buff: "Your Hero Power becomes 'Deal 2 damage'. If already in Shadowform: 3 damage."
	 * 
	 * @param action
	 *            the action that just took place
	 * @param minion
