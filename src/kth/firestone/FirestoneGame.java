...
public class FirestoneGame implements Game {
    ...
    public FirestoneGame(List<Player> players, PlayCardHandler playCardHandler, AttackHandler attackHandler,
    ...
    public boolean isActive() {
        if (players.get(0).getHero().getHealth() > 0 && players.get(1).getHero().getHealth() > 0) {
            return true;
        }
        return false;
    }
