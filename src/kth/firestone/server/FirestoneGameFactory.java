...
public class FirestoneGameFactory implements GameFactory {
    ...
    public Game createGame() {
        ...
        // set starting state
        int startingMana = 0;
        String[] deckStrings = { "Imp", "War Golem", "Boulderfist Ogre", "Ironforge Rifleman", "Blackwing Corruptor",
                "Twilight Drake", "Edwin VanCleef", "Midnight Drake", "Wild Pyromancer", "Frostbolt", "Shadowstep",
                "Backstab", "Equality", "Shadowform", "Alexstrasza", "Acolyte of Pain", "Lorewalker Cho" };
